...
/*                                                                            */
/*                                                        :::      ::::::::   */
/*   check_name_texture.c                               :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
/*   By: mvignes <mvignes@student.42.fr>            +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2026/06/08 14:37:20 by lyaberge          #+#    #+#             */
/*   Updated: 2026/06/10 20:15:22 by mvignes          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
// to check if the extension of .cub is valid in the map input
